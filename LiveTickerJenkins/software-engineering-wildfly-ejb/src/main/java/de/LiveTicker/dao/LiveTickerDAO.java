...
public class LiveTickerDAO implements LiveTickerDAOLocal {
	...
	/**
	 * Methode zum suchen eines Teams nach ID
	...
	/**
	 * Methode zum suchen eines Teams nach Name
	...
	/**
	 * Methode zum hinzufuegen eines Favoriten
	 * @param user - User hat seine Favoriten
	 * @param newTeam - welches Team als Favoriten gesetzt werden soll
	 */
	...
	/**
	 * Methode zum loeschen eines Favoriten
	 * @param user - Welcher User
	 * @param id 
	 */
	...
	/**
	 * Zeigt die Favoriten eines Users
	 * @param user - Welcher User 
	 * @return gibt die Liste mit Favoriten zurück
	 */
